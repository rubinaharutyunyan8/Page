const second_block_data = [
  {
    ...
    img: "assets/images/Second_block/logo1.png",
    pic: "assets/images/Second_block/pic1.png",
  },

  {
    header: "Energy",
    disc: "Our homes fix climate change.",
    img: "assets/images/Second_block/logo2.png",
    pic: "assets/images/Second_block/pic2.png",
  },
  {
    header: "Aerospace",
    disc: "We unlock the scale of space",
    img: "assets/images/Second_block/logo3.png",
    pic: "assets/images/Second_block/pic3.png",
  },
  {
    header: "ROBOTICS",
    disc: "We automate dangerous jobs.",
    img: "assets/images/Second_block/logo4.png",
    pic: "assets/images/Second_block/pic4.png",
  },
  {
    header: "BIO",
    disc: "We cure the worst diseases.",
    img: "assets/images/Second_block/logo5.png",
    pic: "assets/images/Second_block/pic5.png",
  },
];
...
const third_block_data2 = [
  {
    ...
    disc: "naming\nidentity design\nWEB DESIGN",
    pic: "assets/images/Third_block/pic4.png",
  },

  {
    header: "DEVELOP THEIR DECK",
    disc: "STRATEGY + story copywriting\ndesign",
    pic: "assets/images/Third_block/pic5.png",
  },
  {
    header: "SPREAD THEIR STORY",
    disc: "SOCIAL STRATEGY\npr strategy\nviral campaigns",
    pic: "assets/images/Third_block/pic6.png",
  },
];
...
third_block_data2.map((item) => {
  ...
  imgLayer.src = `assets/images/Third_block/layer2.png`;
  imgLayer.alt = "layer2";
...
const third_block_data3 = [
  {
    ...
    pic: "assets/images/Third_block/pic7.png",
  },
  {
    header: "DAN",
    disc: "CO-FOUNDER & CMO",
    ...
    pic: "assets/images/Third_block/pic8.png",
  },
];
...
const data_section_4 = [
  { img: "assets/images/4rd_Block/icons/pic1.png", text: "4X" },

  { img: "assets/images/4rd_Block/icons/pic2.png", text: "3X" },
  { img: "assets/images/4rd_Block/icons/pic3.png", text: "2X" },
  { img: "assets/images/4rd_Block/icons/pic4.png", text: "2X" },

  { img: "assets/images/4rd_Block/icons/pic5.png", text: "2X" },
  { img: "assets/images/4rd_Block/icons/pic6.png", text: "1X" },

  { img: "assets/images/4rd_Block/icons/pic7.png", text: "1X" },
  { img: "assets/images/4rd_Block/icons/pic8.png", text: "1X" },
];
...
const data_section_6 = [
  {
    img: "assets/images/6rd_Block/pic1.png",
    header: "PRODUCTS",
    text: "2K + SHARES",
    pic: "assets/images/6rd_Block/icons/icon1.png",
  },

  {
    img: "assets/images/6rd_Block/pic2.png",
    header: "GIFTS",
    text1: "MAGIC x EVERYONE",
    text: "1MM+ VIEWS",
  },
  {
    img: "assets/images/6rd_Block/pic3.png",
    header: "VIDEOS",
    text: "3MM+ VIEWS",
    pic: "assets/images/6rd_Block/icons/icon2.png",
  },
];
...
data_section_6.map((item, index) => {
 ...
 itemDiv.style.padding= "0px";
  ...
  if (index === 1) {
    text1.classList.add("disc");
    text1.textContent = item.text1;
    text1.style.marginBottom = '-30px';
...
const data_section_7 = [
  { img: "assets/images/7rd_Block/pic1.png", header: "BRAND \n BOOK" },

  { img: "assets/images/7rd_Block/pic2.png", header: "pitchdeck \n framework" },
  {
    img: "assets/images/7rd_Block/pic3.png",
...
const caseStudies = [
  {
    ...
    images: [
      "assets/images/14_block/one.png",
      "assets/images/14_block/two.png",
    ],
  },
  {
    id: "002",
    ...
    images: [
      "assets/images/14_block/three.png",
      "assets/images/14_block/four.png",
    ],
  },
  {
    id: "003",
    ...
    images: [
      "assets/images/14_block/five.png",
      "assets/images/14_block/six.png",
    ],
  },
];
